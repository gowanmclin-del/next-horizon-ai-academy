      ...
      <div className="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        {status === "paid" && (
          <>
            ...
            <p className="mt-3 text-sm text-slate-600">
              Your enrollment has been confirmed by our server — not just by this page. Head to your dashboard to
              start learning.
            </p>
            <a href="/dashboard" className="mt-6 inline-block rounded-md bg-horizon-blue px-6 py-3 text-sm font-semibold text-white hover:bg-horizon-navy">
              Go to Dashboard
            </a>
          </>
        )}
        ...
        {status === "pending" && (
          <>
            ...
            <p className="mt-3 text-sm text-slate-600">
              Stripe is still confirming your payment. This page does not grant access on its own — refresh in a
              minute, or check your dashboard shortly. If this persists, contact support with your confirmation
              email.
            </p>
        ...
        {status === "failed" && (
          <>
            ...
            <a href={`/courses/${slug}`} className="mt-6 inline-block rounded-md bg-horizon-blue px-6 py-3 text-sm font-semibold text-white hover:bg-horizon-navy">
              Back to Course
            </a>
          </>
        )}
